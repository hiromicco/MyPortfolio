...
class MobileMenu {
  constructor() {
    ...
    this.DOM.links = document.querySelectorAll('.side__link');
  ...
  _addEvent() {
    ...
    this.DOM.links.forEach(link => {
      link.addEventListener('click', this._toggleClass.bind(this))
    });
  }
  _toggleClass() {
  ...
  _removeClass() {
    // this.DOM.container.classList.remove('menu_open');
  }
}
